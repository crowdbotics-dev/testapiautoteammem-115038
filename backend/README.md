...
## Project Structure
    ...
    ├── testapiautoteammem_115038  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_115038`
...
2. Clone this repo and `cd testapiautoteammem_115038`
